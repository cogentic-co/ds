...
function TronIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        d="M61.55 19.28L33.53 1.28C33.13 1.02 32.67 0.89 32.2 0.89C31.88 0.89 31.56 0.95 31.26 1.09L2.86 13.68C2.15 13.99 1.65 14.64 1.53 15.41C1.41 16.18 1.68 16.96 2.25 17.49L27.85 41.19L30.37 62.19C30.48 63.08 31.14 63.8 32.01 63.99C32.16 64.02 32.31 64.04 32.46 64.04C33.18 64.04 33.86 63.68 34.27 63.08L62.67 21.48C63.17 20.75 63.16 19.78 61.55 19.28ZM34.21 55.22L32.27 38.97L51.93 22.5L34.21 55.22ZM29.07 37.21L8.1 16.06L28.56 7.02L48.63 20.11L29.07 37.21Z"
        fill="currentColor"
      />
    </svg>
  )
...
function SolanaIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 398 312" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        d="M64.6 237.9C66.5 236 69 234.9 71.7 234.9H391.5C395.8 234.9 398 240.1 395 243.1L333.4 304.7C331.5 306.6 329 307.7 326.3 307.7H6.5C2.2 307.7 0 302.5 3 299.5L64.6 237.9Z"
        fill="currentColor"
      />
      <path
        d="M64.6 7.4C66.6 5.5 69.1 4.4 71.7 4.4H391.5C395.8 4.4 398 9.6 395 12.6L333.4 74.2C331.5 76.1 329 77.2 326.3 77.2H6.5C2.2 77.2 0 72 3 69L64.6 7.4Z"
        fill="currentColor"
      />
      <path
        d="M333.4 121.8C331.5 119.9 329 118.8 326.3 118.8H6.5C2.2 118.8 0 124 3 127L64.6 188.6C66.5 190.5 69 191.6 71.7 191.6H391.5C395.8 191.6 398 186.4 395 183.4L333.4 121.8Z"
        fill="currentColor"
      />
    </svg>
  )
...
function BnbIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        d="M9.8 21.8L16 28L22.2 21.8L19.8 19.4L16 23.2L12.2 19.4L9.8 21.8Z"
        fill="currentColor"
      />
...
export { BitcoinIcon, BnbIcon, CHAIN_ICONS, EthereumIcon, PolygonIcon, SolanaIcon, TronIcon }
