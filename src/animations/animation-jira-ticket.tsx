...
export default function AnimationJiraTicket({ className }: { className?: string }) {
  return (
    <div className={cn("flex flex-col bg-white p-4", className)}>
      ...
      >
        <h4 className="mt-2 font-semibold text-gray-900 text-sm leading-snug">
        ...
        >
          <span className="rounded bg-blue-100 px-2 py-0.5 font-bold text-2xs text-blue-700">
            IN REVIEW
          </span>
          ...
          <span className="flex items-center gap-1 text-2xs text-gray-500">
            <span className="inline-flex size-4 items-center justify-center rounded-full bg-emerald-100 font-bold text-3xs text-emerald-700">
              JC
            </span>
            J. Chen
          </span>
          <span className="flex items-center gap-1 rounded bg-red-50 px-1.5 py-0.5 font-semibold text-2xs text-red-600">
      ...
      >
        <p className="font-semibold text-2xs text-gray-400 uppercase tracking-wider">
        ...
        <div className="mt-2 space-y-1.5">
          {[
            ...
            >
              <span className="w-[80px] shrink-0 font-medium text-2xs text-gray-400">
                {row.label}
              </span>
              <span className="font-medium text-2xs text-gray-700">{row.value}</span>
            </motion.div>
          ))}
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="mt-3"
      >
        <p className="font-semibold text-2xs text-gray-400 uppercase tracking-wider">Activity</p>
