...
const waffleChartVariants = cva("w-full text-foreground", {
  ...
  compoundVariants: [
    ...
    { mode: "grid", size: "xs", className: "aspect-square max-w-32" },
    { mode: "grid", size: "sm", className: "aspect-square max-w-48" },
    { mode: "grid", size: "default", className: "aspect-square max-w-sm" },
    { mode: "grid", size: "lg", className: "aspect-square max-w-lg" },
  ],
  defaultVariants: {
    mode: "grid",
    size: "default",
