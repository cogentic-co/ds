  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-6 rounded-xl border border-border-light bg-card p-6 text-sm shadow-[var(--shadow-lifted)] outline-none duration-100 data-closed:animate-out data-open:animate-in sm:max-w-md",
          className,
        )}
        {...props}
      >
