  ...
  return (
    <aside
      ...
      className={cn(
        ...
        "group-has-[[data-state=collapsed]]/shell:mr-2 group-has-[[data-state=collapsed]]/shell:rounded-xl group-has-[[data-state=collapsed]]/shell:border-r group-has-[[data-state=collapsed]]/shell:delay-200",
        className,
      )}
    >
