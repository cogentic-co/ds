...
function IconRail({
  ...
  return (
    <aside
      data-slot="icon-rail"
      className={cn(
        "z-20 my-2 ml-2 flex h-[calc(100svh-1rem)] w-14 shrink-0 flex-col items-center rounded-l-xl border border-border bg-card py-3 transition-[border-radius,margin] duration-200",
