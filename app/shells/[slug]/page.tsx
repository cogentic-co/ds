...
import { shellPreviews } from "./previews"
...
export default function ShellPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = use(params)
  const Preview = shellPreviews[slug]
    ...
    <div className="space-y-8">
      ...
      {Preview ? (
        ...
        <div className="rounded-lg border border-dashed p-12 text-center text-muted-foreground text-sm">
          No preview available yet for this shell.
        </div>
      )}
