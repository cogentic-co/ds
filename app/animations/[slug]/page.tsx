...
import { animationPreviews } from "./previews"
...
export default function AnimationPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = use(params)
  const Preview = animationPreviews[slug]
    ...
    <div className="space-y-8">
      ...
      {Preview ? (
        ...
        <div className="rounded-lg border border-dashed p-12 text-center text-muted-foreground text-sm">
          No preview available yet for this animation.
        </div>
      )}
